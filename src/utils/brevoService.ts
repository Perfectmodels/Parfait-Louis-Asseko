...
/** Notification admin pour un vote Miss One Light */
export const sendVoteNotificationToAdmin = (p: {
  ...
  sendEmail({
    ...
    subject: `[Miss One Light] Nouveau vote de ${p.voterName} pour ${p.candidateName}`,
    htmlContent: buildEmailTemplate(`
      <div style="background:#c9a84c0d;border-left:3px solid #c9a84c;border-radius:4px;padding:16px 20px;margin-bottom:28px">
        <p style="color:#c9a84c;font-size:11px;letter-spacing:4px;text-transform:uppercase;margin:0 0 4px">Nouveau vote Miss One Light</p>
        <p style="color:#f5f0e8;font-size:18px;font-weight:bold;margin:0">${p.candidateName} (+${p.votes} votes)</p>
      </div>
      <table style="width:100%;border-collapse:collapse;margin-bottom:24px">
        ...
        <tr><td style="padding:10px 0;border-bottom:1px solid #ffffff0d;color:#c9a84c;font-size:11px;text-transform:uppercase;letter-spacing:2px">Nombre de votes</td><td style="padding:10px 0;border-bottom:1px solid #ffffff0d;color:#f5f0e8">${p.votes}</td></tr>
        <tr><td style="padding:10px 0;border-bottom:1px solid #ffffff0d;color:#c9a84c;font-size:11px;text-transform:uppercase;letter-spacing:2px">Montant à régler</td><td style="padding:10px 0;border-bottom:1px solid #ffffff0d;color:#f5f0e8">${p.amount} FCFA</td></tr>
        <tr><td style="padding:10px 0;border-bottom:1px solid #ffffff0d;color:#c9a84c;font-size:11px;text-transform:uppercase;letter-spacing:2px">Réf. transaction</td><td style="padding:10px 0;border-bottom:1px solid #ffffff0d;color:#f5f0e8">${p.txRef}</td></tr>
      </table>
