...
// ⚡ Bolt: Wrapped in React.memo() to prevent unnecessary re-renders of framer-motion elements
// when search/filter state changes in parent components (like Models.tsx), avoiding input lag.
