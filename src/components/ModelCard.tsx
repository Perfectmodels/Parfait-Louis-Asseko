...
// ⚡ Bolt Optimization: Memoize the component to prevent expensive framer-motion re-renders
// when the parent Models component updates state (e.g., during search input)
