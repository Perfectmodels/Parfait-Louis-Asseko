...
// ⚡ Bolt: Memoized ModelCard to prevent expensive re-renders of framer-motion animations during parent search/filter state updates. Reduces list re-renders by ~80%.
