                    ...
                    <>
                        ...
                        >
                            <div className="flex items-center justify-between mb-16 px-4">
                                ...
                                <button onClick={() => setSidebarOpen(false)} aria-label="Fermer le menu" className="text-white/40 hover:text-white"><XMarkIcon className="w-6 h-6" /></button>
                            </div>
            ...
            <div className="flex flex-col flex-1 lg:pl-72 min-w-0">
                <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-white/5 bg-pm-dark/60 backdrop-blur-xl px-4 sm:px-6 lg:px-10">
                    <div className="flex items-center gap-3 sm:gap-6 min-w-0 flex-1">
                        <button onClick={() => setSidebarOpen(true)} aria-label="Ouvrir le menu" className="lg:hidden p-2 text-pm-off-white/80 shrink-0">
