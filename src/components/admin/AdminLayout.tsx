                    ...
                    <>
                        ...
                        >
                            <div className="flex items-center justify-between mb-16 px-4">
                                ...
                                <button
                                    onClick={() => setSidebarOpen(false)}
                                    className="text-white/40 hover:text-white rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pm-gold"
                ...
                <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-white/5 bg-pm-dark/60 backdrop-blur-xl px-6 sm:px-10">
                    <div className="flex items-center gap-6">
                        <button
                            ...
                            className="lg:hidden p-2 text-pm-off-white/80 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pm-gold"
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className={`p-2 rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pm-gold ${
                                permission === 'granted'
                                    ? 'text-pm-gold'
                                    : permission === 'denied'
