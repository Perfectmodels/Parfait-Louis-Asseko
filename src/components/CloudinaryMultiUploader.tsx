          ...
          {values.map((url, i) => (
            <div key={i} className="relative group aspect-square">
              ...
              <button
                ...
                className="absolute top-1 right-1 bg-black/70 rounded-full p-0.5 text-white/60 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pm-gold focus-visible:opacity-100"
              >
