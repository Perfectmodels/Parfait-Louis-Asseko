...
export const useRealtimeDB = () => {
    ...
    const getInitialData = useCallback(async (): Promise<AppData> => {
        ...
        return {
            ...
            faqData: d.faqData,
            adminProfile: { id: 'admin', name: 'Admin Principal', username: 'admin', passwordHash: '0e89f223e226ae63268cf39152ab75722e811b89d29efb22a852f1667bd22ae0', email: 'contact@perfectmodels.ga' },
            gallery: [],
            galleryAlbums: [],
            transactions: [],
