...
export const mailingContacts: MailingContact[] = [
  ...
  { id: 'mc-81', name: '2LA Énergies et Services', email: 'laurent.ntoutoume@2laenergiesetservices.com', category: 'Logistique & Transport' },
  { id: 'mc-82', name: 'Agglos BTP Gabon', email: 'agglosbtpgabon20@gmail.com', category: 'Logistique & Transport' },
  { id: 'mc-83', name: 'Arcadia Inter', email: 'hello@arcadia-inter.com', category: 'Logistique & Transport' },
  { id: 'mc-84', name: 'BE Construction', email: 'contact@be-construction.net', category: 'Logistique & Transport' },
  { id: 'mc-85', name: 'Salah Moukarim', email: 'salah.moukarim@hotmail.fr', category: 'Logistique & Transport' },
  { id: 'mc-86', name: 'BMC Architecture', email: 'contact@bmcarchitecture.net', category: 'Logistique & Transport' },
  { id: 'mc-87', name: 'ACINS Afrique', email: 'infos@acins-afrique.com', category: 'Logistique & Transport' },
  { id: 'mc-88', name: 'Building Concept', email: 'buildingconcept2017@gmail.com', category: 'Logistique & Transport' },
  { id: 'mc-89', name: 'CGE Gabon', email: 'cge@cge-gabon.com', category: 'Logistique & Transport' },
  { id: 'mc-90', name: 'EKOK BTP', email: 'yannicknkea@ekokbtp.com', category: 'Logistique & Transport' },
  { id: 'mc-91', name: 'FACO Construction', email: 'contact@faco-construction.com', category: 'Logistique & Transport' },
  { id: 'mc-92', name: 'Société GATES', email: 'societegates@yahoo.com', category: 'Logistique & Transport' },
  { id: 'mc-93', name: 'GIGS 2020 BTP', email: 'gigs2020btp@gmail.com', category: 'Logistique & Transport' },
  { id: 'mc-94', name: 'GIEEBI GAB', email: 'gieebi.gab@gmail.com', category: 'Logistique & Transport' },
  { id: 'mc-95', name: 'OKLICEANE', email: 'contact@okliceane.com', category: 'Logistique & Transport' },
  { id: 'mc-96', name: 'OS Construction GB', email: 'contact@osconstructiongb.com', category: 'Logistique & Transport' },
  { id: 'mc-97', name: 'PF BTP Télécoms', email: 'pfbtptelecoms@ap-holding.ga', category: 'Logistique & Transport' },
  { id: 'mc-98', name: 'Plenitude Gabon Services', email: 'plenitudegabonservices@gmail.com', category: 'Logistique & Transport' },
  { id: 'mc-99', name: 'SETEG Gabon', email: 'seteggabon@yahoo.fr', category: 'Logistique & Transport' },
  { id: 'mc-100', name: 'SGTT SA', email: 'contacte.sgtt_sa@yahoo.com', category: 'Logistique & Transport' },
  { id: 'mc-101', name: 'SMS Société Méga Services', email: 'sms@societemegaservices.com', category: 'Logistique & Transport' },
  { id: 'mc-102', name: 'SOCOBA', email: 'socoba@socoba-edtpl.com', category: 'Logistique & Transport' },
  { id: 'mc-103', name: 'SOTRALGA', email: 'commercial@sotralga.com', category: 'Logistique & Transport' },
  { id: 'mc-104', name: 'SYM BTP', email: 'symbtp@gmail.com', category: 'Logistique & Transport' },
  { id: 'mc-105', name: 'West Alliance Gabon', email: 'contact@westalliancegabon.com', category: 'Logistique & Transport' },
  // Industrie
  { id: 'mc-106', name: 'ADMII SM', email: 'admii_sm@hotmail.com', category: 'Industrie' },
  { id: 'mc-107', name: 'Africamat', email: 'contact@africamat.com', category: 'Industrie' },
  { id: 'mc-108', name: 'Bernabé Gabon', email: 'info.gb@bernabeafrique.com', category: 'Industrie' },
  { id: 'mc-109', name: 'Gabonaise de Chimie', email: 'contact@gabonaisedechimie.com', category: 'Industrie' },
  { id: 'mc-110', name: 'IPES Gabon', email: 'info@ipes-gabon.com', category: 'Industrie' },
  { id: 'mc-111', name: 'OPRAG Bernabé', email: 'commercial.oprag@bernabeafrique.com', category: 'Industrie' },
  // Média (Suite)
  { id: 'mc-112', name: 'Accent Gabon', email: 'contact@accent-gabon.com', category: 'Média' },
  { id: 'mc-113', name: 'AG Partners', email: 'libreville@ag-partners.com', category: 'Média' },
  { id: 'mc-114', name: 'Equatoria Prod', email: 'yoan@equatoriaprod.com', category: 'Média' },
  { id: 'mc-115', name: 'Gabon 24', email: 'infogabon24@gmail.com', category: 'Média' },
  { id: 'mc-116', name: 'Gabon Media Time', email: 'contact@gabonmediatime.com', category: 'Média' },
  { id: 'mc-117', name: 'Gabonreview', email: 'redaction.gabonreview@gmail.com', category: 'Média' },
  // Droit & Consulting (Suite)
  { id: 'mc-118', name: '2HS Consulting', email: '2hsconsulting2019@gmail.com', category: 'Droit & Consulting' },
  { id: 'mc-119', name: 'Sergi Ekoumba', email: 'sergiekoumbandembi@gmail.com', category: 'Droit & Consulting' },
  { id: 'mc-120', name: '3 Boss Partners', email: 'contact@3bosspartners.com', category: 'Droit & Consulting' },
  { id: 'mc-121', name: 'Cabinet 3M Consulting', email: 'contact@cabinet3mconsulting.com', category: 'Droit & Consulting' },
  { id: 'mc-122', name: '3MPC GAB', email: 'g.mboza@3mpc-gab.com', category: 'Droit & Consulting' },
  { id: 'mc-123', name: 'A&P Consulting Africa', email: 'contact@a-pconsulting-africa.com', category: 'Droit & Consulting' },
  { id: 'mc-124', name: 'AB Location Gabon', email: 'ablocationgabon@hotmail.com', category: 'Droit & Consulting' },
  // Autre
  { id: 'mc-125', name: 'Climat Froid Gabon', email: 'climatfroidgabon@gmail.com', category: 'Autre' },
  { id: 'mc-126', name: 'EIT Groupe', email: 'eit@groupe-eit.com', category: 'Autre' },
  { id: 'mc-127', name: 'Mandji Électricité', email: 'mandjielectriciteplomberie@yahoo.fr', category: 'Autre' },
  { id: 'mc-128', name: 'SMG POG', email: 'smg.pog@gmail.com', category: 'Autre' },
];
