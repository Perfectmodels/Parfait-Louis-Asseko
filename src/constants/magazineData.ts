...
export const articles: Article[] = [
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://via.placeholder.com/400x600/D4AF37/FFFFFF?text=Model', alt: 'Noemi Kim lors d\'un shooting', caption: 'Une prestance royale, héritage de son titre de Miss Gabon.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://via.placeholder.com/400x600/D4AF37/FFFFFF?text=Model', alt: 'Yann Aubin en shooting', caption: 'Une présence qui captive l\'objectif.' },
