import { Article, PhotoGallery } from '../../types';
...
export const photoGalleries: PhotoGallery[] = [
  {
    ...
    category: 'runway',
    photographer: 'Perfect Models Team',
    models: [],
    images: [
      {
        id: '1',
        ...
        caption: 'Les meilleurs moments de notre événement annuel',
        tags: ['Fashion Day', 'Défilé', '2024']
      },
      {
        id: '2',
        url: 'https://i.ibb.co/Rk1fG3ph/farelmd-37.jpg',
        alt: 'Farel MD Collection',
        caption: 'Collection Farel MD - Perfect Fashion Day 2024',
        tags: ['Fashion Day', 'Défilé', '2024']
      },
      {
        id: '3',
        url: 'https://i.ibb.co/TBt9FBSv/AJC-4630.jpg',
        alt: 'AJ Caramela Shooting',
        caption: 'AJ Caramela - Perfect Fashion Day 2024',
        tags: ['Fashion Day', 'Défilé', '2024']
      }
    ],
    tags: ['Fashion Day', 'Défilé', '2024'],
