...
const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const adminUser = data.adminProfile || { name: 'Admin', username: 'admin', password: 'admin2025' };
    // Fallback to hardcoded if not yet in DB, though useFirestore provides default.
