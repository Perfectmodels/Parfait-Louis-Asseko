            ...
            <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                    <main className="lg:col-span-2 space-y-12">
                        ...
                        <Section title="Gestion des Talents" icon={UsersIcon}>
                            <DashboardCard title="Mannequins" icon={UsersIcon} link="/admin/models" description="Base de données et profils." highlight />
                            ...
                            <DashboardCard title="Bookings" icon={BriefcaseIcon} link="/admin/bookings" description="Demandes clients." notificationCount={stats.newBookingRequests} />
                            <DashboardCard title="Accès & Sécurité" icon={Cog6ToothIcon} link="/admin/model-access" description="Gestion des accès." />
                        </Section>

                        {/* 2. Formation (Classroom) */}
                        <Section title="Formation (Classroom)" icon={PresentationChartLineIcon}>
                            <DashboardCard title="Parcours & Modules" icon={PresentationChartLineIcon} link="/admin/classroom" description="Gérer les cours." />
                            <DashboardCard title="Progression" icon={SignalIcon} link="/admin/classroom-progress" description="Suivi des élèves." />
                            <DashboardCard title="Absences" icon={CalendarDaysIcon} link="/admin/absences" description="Suivi des présences." />
                        </Section>

                        {/* 3. Événementiel */}
                        <Section title="Événementiel (PFD)" icon={CalendarDaysIcon}>
                            <DashboardCard title="Gestion PFD" icon={CalendarDaysIcon} link="/admin/fashion-day-events" description="Éditions et Promos." />
                            <DashboardCard title="Candidatures" icon={UsersIcon} link="/admin/fashion-day-applications" description="Mannequins & Créateurs." notificationCount={stats.newCastingApps} />
                            <DashboardCard title="Réservations" icon={CurrencyDollarIcon} link="/admin/fashion-day-reservations" description="Billetterie et Tables." />
                            <DashboardCard title="Casting Live" icon={UsersIcon} link="/admin/casting-live" description="Outil de notation jury." />
                        </Section>

                        {/* 4. Contenu & Comms */}
                        <Section title="Contenu & Communication" icon={NewspaperIcon}>
                            <DashboardCard title="Magazine" icon={NewspaperIcon} link="/admin/magazine" description="Articles de blog." />
                            <DashboardCard title="Actualités" icon={SignalIcon} link="/admin/news" description="Bandeau d'info." />
                            <DashboardCard title="Direction Artistique" icon={PaintBrushIcon} link="/admin/artistic-direction" description="Briefs créatifs." />
                            <DashboardCard title="Commentaires" icon={EnvelopeIcon} link="/admin/comments" description="Modération." highlight={stats.newMessages > 0} />
                        </Section>

                        {/* 5. Administration Globale */}
                        <Section title="Administration Globale" icon={BuildingStorefrontIcon}>
                            <DashboardCard title="L'Agence" icon={HomeIcon} link="/admin/agency" description="Infos et Histoire." />
                            <DashboardCard title="Comptabilité" icon={CurrencyDollarIcon} link="/admin/payments" description="Suivi financier." />
                            <DashboardCard title="Paramètres Site" icon={Cog6ToothIcon} link="/admin/settings" description="Config & Images." />
                            <DashboardCard title="Récupération" icon={ArrowRightOnRectangleIcon} link="/admin/recovery-requests" description="Demandes de mot de passe." />
                        </Section>
                    </main>
