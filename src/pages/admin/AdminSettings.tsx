            ...
            <div className="container mx-auto px-6">
                ...
                <div className="space-y-8">
                    ...
                    <div className="admin-section-wrapper">
                        ...
                        <h2 className="admin-section-title">Images Globales du Site</h2>
                        <div className="space-y-4">
                            <ImageUploader label="Logo" value={localData.siteConfig.logo} onChange={value => handleSimpleChange('siteConfig', 'logo', value)} />
                            <ImageUploader label="Image Principale (Partage Social / SEO)" value={localData.siteImages.hero} onChange={value => handleSimpleChange('siteImages', 'hero', value)} />
