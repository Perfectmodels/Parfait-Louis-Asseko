...
const FormInput: React.FC<{ label: string, value: any, onChange: any, type?: string }> = ({ label, value, onChange, type = "text" }) => (
    <div>
        ...
        <input type={type} value={value} onChange={onChange} className="admin-input" placeholder={label} />
    </div>
);
...
const FormTextArea: React.FC<{ label: string, value: any, onChange: any }> = ({ label, value, onChange }) => (
    <div>
        <label className="admin-label">{label}</label>
        <textarea value={value} onChange={onChange} rows={4} className="admin-input admin-textarea" placeholder={label} />
    </div>
);
