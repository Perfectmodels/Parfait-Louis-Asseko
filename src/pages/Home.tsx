...
import { ArrowLongRightIcon, TicketIcon, ChevronLeftIcon, ChevronRightIcon, PhotoIcon, CalendarDaysIcon } from '@heroicons/react/24/outline';
...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-pm-dark overflow-x-hidden">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-pm-dark via-[#0a0a0a] to-pm-dark border-y border-pm-gold/20">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(212,175,55,0.08),transparent_50%)]" />
        <div className="relative max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-12 py-12 sm:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Image */}
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-pm-gold/10 border border-pm-gold/20 order-2 lg:order-1">
              <img
            ...
            <div className="space-y-5 order-1 lg:order-2">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-black italic mt-3 leading-tight">
                  ✨ Révélez l'élite<br />
              ...
              <p className="text-white/60 leading-relaxed text-sm sm:text-base">
                L'agence Perfect Models Management lance sa grande campagne de recrutement national pour dénicher les nouveaux visages qui feront rayonner la mode de demain.
              </p>

              {/* Dates */}
              <div className="flex items-center gap-3 bg-pm-gold/10 border border-pm-gold/30 rounded-xl px-4 py-3">
                <CalendarDaysIcon className="w-5 h-5 text-pm-gold shrink-0" />
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-pm-gold/60 mb-0.5">Période de recrutement</p>
                  <p className="text-white font-bold text-sm">Du 13 avril au 13 juin 2026</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-[#25D366]/10 border border-[#25D366]/30 rounded-xl px-5 py-3 hover:bg-[#25D366]/20 transition-colors text-[#25D366] font-bold text-sm"
                >
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-2 bg-pm-gold/10 border border-pm-gold/30 rounded-xl px-5 py-3 hover:bg-pm-gold/20 transition-colors text-pm-gold font-bold text-sm"
                >
