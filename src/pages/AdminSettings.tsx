...
const AdminSettings: React.FC = () => {
    ...
    const [isTestimonialGeneratorOpen, setIsTestimonialGeneratorOpen] = useState(false);
    ...
    const handleTestimonialGenerated = (testimonial: Testimonial) => {
        if (localData) {
            setLocalData({
                ...localData,
                testimonials: [...localData.testimonials, testimonial]
            });
        }
    };
    ...
    return (
        <div className="bg-pm-dark text-pm-off-white py-20 min-h-screen">
                ...
                <div className="space-y-8">
                    <div className="admin-section-wrapper">
                        ...
                        <div className="space-y-4">
                            <FormInput label="Email public" value={localData.contactInfo.email} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('contactInfo', 'email', e.target.value)} />
                            <FormInput label="Téléphone" value={localData.contactInfo.phone} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('contactInfo', 'phone', e.target.value)} />
                            <FormInput label="Adresse" value={localData.contactInfo.address} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('contactInfo', 'address', e.target.value)} />
                        </div>
                    </div>
                    ...
                    <div className="admin-section-wrapper">
                        ...
                        <div className="space-y-4">
                            <FormInput label="Clé API Gemini (pour l'assistant IA)" value={localData.apiKeys.geminiApiKey || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('apiKeys', 'geminiApiKey', e.target.value)} />
                            <FormInput label="Clé API Brevo (pour les emails)" value={localData.apiKeys.brevoApiKey || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('apiKeys', 'brevoApiKey', e.target.value)} />
                            <FormInput label="Clé API ImgBB (pour les images)" value={localData.apiKeys.imgbbApiKey || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('apiKeys', 'imgbbApiKey', e.target.value)} />
                        </div>
                    </div>
                    ...
                    <div className="admin-section-wrapper">
                     ...
                     <div className="admin-section-wrapper">
                        ...
                        <div className="space-y-4">
                            <FormInput label="URL Facebook" value={localData.socialLinks.facebook} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('socialLinks', 'facebook', e.target.value)} />
                            <FormInput label="URL Instagram" value={localData.socialLinks.instagram} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('socialLinks', 'instagram', e.target.value)} />
                            <FormInput label="URL YouTube" value={localData.socialLinks.youtube} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSimpleChange('socialLinks', 'youtube', e.target.value)} />
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                            <ArrayEditor 
                                ...
                                renderItem={(item: Partner, updateItem) => (
                                    <FormInput label="Nom du partenaire" value={item.name} onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateItem({ ...item, name: e.target.value })} />
                                )}
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center mb-4">
                                <p className="text-sm text-pm-off-white/70">
                                    Gérez les témoignages clients et partenaires
                                </p>
                                <button
                                    onClick={() => setIsTestimonialGeneratorOpen(true)}
                                    className="flex items-center gap-2 px-4 py-2 bg-pm-gold text-pm-dark font-medium rounded-lg hover:bg-white transition-colors"
                                >
                            ...
                            <ArrayEditor 
                                ...
                                renderItem={(item: Testimonial, updateItem) => (
                                    <>
                                        <FormInput label="Nom" value={item.name} onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateItem({ ...item, name: e.target.value })} />
                                        <FormInput label="Rôle" value={item.role} onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateItem({ ...item, role: e.target.value })} />
                                        <ImageUploader label="Photo" value={item.imageUrl} onChange={value => updateItem({ ...item, imageUrl: value })} />
                                        <FormTextArea 
                                            label="Citation" 
                                            value={item.quote} 
                                            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateItem({ ...item, quote: e.target.value })}
                                        />
                                    </>
                                )}
                    ...
                    <div className="admin-section-wrapper">
                        ...
                        <ArrayEditor 
                            ...
                            renderItem={(item: FAQCategory, updateItem) => (
                                <>
                                    <FormInput label="Catégorie" value={item.category} onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateItem({ ...item, category: e.target.value })} />
                                    <SubArrayEditor
                                        title="Questions"
                                        items={item.items || []}
                                        ...
                                        renderItem={(faq: FAQItem, updateFaq) => (
                                            <>
                                                <FormInput label="Question" value={faq.question} onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateFaq({ ...faq, question: e.target.value })} />
                                                <FormTextArea label="Réponse" value={faq.answer} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateFaq({ ...faq, answer: e.target.value })} />
                                            </>
                                        )}
                                    />
                                </>
            ...
            <TestimonialGenerator 
                isOpen={isTestimonialGeneratorOpen}
                onClose={() => setIsTestimonialGeneratorOpen(false)}
                onTestimonialGenerated={handleTestimonialGenerated}
            />
        </div>
    );
};
