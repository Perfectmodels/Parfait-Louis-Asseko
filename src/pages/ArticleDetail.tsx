            ...
            <div class="page">
                <header class="header">
                    <div>
                        ...
                        <p class="meta">Par ${escapeHtml(article.author)} • ${escapeHtml(new Date(article.date).toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' }))}</p>
                    </div>
                ...
                <footer class="footer">&copy; ${escapeHtml(new Date().getFullYear().toString())} Perfect Models Management - Focus Model 241</footer>
            </div>
        </body>
        </html>
    `;
