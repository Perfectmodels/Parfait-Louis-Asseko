    ...
    <div className="bg-pm-dark text-pm-off-white py-20 min-h-screen">
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="flex justify-between items-center mb-8 print-hide">
          <Link href="/classroom-debutant" className="inline-flex items-center gap-2 text-pm-gold hover:underline">
        ...
        {module.quiz && module.quiz.length > 0 && (
            <BeginnerQuiz quiz={module.quiz} moduleSlug={module.slug as string} />
        )}
