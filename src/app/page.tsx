                        ...
                        <div className="relative z-10 p-6 md:p-10 lg:p-12 text-white md:w-3/4 lg:w-2/3">
                            ...
                            <p className="text-sm md:text-base text-pm-off-white/90 mb-5">{currentNews.excerpt}</p>
                             <div className="flex items-center gap-4">
                                {currentNews.link && (
                                    <Link href={currentNews.link} className="inline-block px-6 py-2 bg-pm-gold text-pm-dark font-bold uppercase tracking-widest text-xs rounded-full transition-all duration-300 hover:bg-white hover:shadow-lg hover:shadow-pm-gold/20">
                                        Lire la suite
                                    </Link>
                                )}
...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-pm-dark text-pm-off-white relative">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-32 h-32 border border-pm-gold/30 rounded-full"></div>
          <div className="absolute top-40 right-32 w-24 h-24 border border-pm-gold/20 rounded-full"></div>
          <div className="absolute bottom-32 left-1/4 w-16 h-16 border border-pm-gold/25 rounded-full"></div>
          <div className="absolute bottom-20 right-20 w-20 h-20 border border-pm-gold/15 rounded-full"></div>
        </div>
      </div>
      ...
      <div className="page-container relative z-40">
        {/* 2. Agency Presentation */}
        <section>
            <div className="content-section bg-black/70 backdrop-blur-sm border-pm-gold/30">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center mt-8">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <Link href="/agence" className="inline-block px-10 py-3 border-2 border-pm-gold text-pm-gold font-bold uppercase tracking-widest text-sm rounded-full transition-all duration-300 hover:bg-pm-gold hover:text-pm-dark">
                            Découvrir l'agence
                        </Link>
                    </div>
                </div>
        ...
        <section>
          <div className="content-section">
            ...
            <div className="text-center mt-12">
              <Link href="/services" className="px-10 py-4 bg-pm-gold text-pm-dark font-bold uppercase tracking-widest text-sm rounded-full text-center transition-all duration-300 hover:bg-white hover:shadow-lg hover:shadow-pm-gold/20">
      ...
      <section className="bg-black py-20 lg:py-28">
        <div className="container mx-auto px-6">
            ...
            <div className="text-center mt-12">
              <Link href="/mannequins" className="px-10 py-4 border-2 border-pm-gold text-pm-gold font-bold uppercase tracking-widest text-sm rounded-full text-center transition-all duration-300 hover:bg-pm-gold hover:text-pm-dark">
        ...
        <section>
          <div className="content-section text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/casting-formulaire" className="w-full sm:w-auto px-10 py-4 bg-pm-gold text-pm-dark font-bold uppercase tracking-widest text-sm rounded-full text-center transition-all duration-300 hover:bg-white hover:shadow-lg hover:shadow-pm-gold/20">
                Postuler
              </Link>
              <Link href="/contact" className="w-full sm:w-auto px-10 py-4 border-2 border-pm-gold text-pm-gold font-bold uppercase tracking-widest text-sm rounded-full text-center transition-all duration-300 hover:bg-pm-gold hover:text-pm-dark">
                Nous Contacter
              </Link>
            </div>
          </div>
