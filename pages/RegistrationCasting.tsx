        ...
        <>
            ...
            <div className="bg-pm-dark text-pm-off-white py-20 min-h-screen">
                <div className="container mx-auto px-6">
                    ...
                    <p className="admin-page-subtitle mb-8">Connecté en tant que {staffName}.</p>

                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        {/* Registration Form */}
                        <div className="lg:col-span-1">
                            <form onSubmit={handleRegister} className="admin-section-wrapper space-y-6">
...
const Section: React.FC<{title: string, children: React.ReactNode}> = ({title, children}) => (
    <div className="space-y-4 pt-4 border-t border-pm-gold/20 first:pt-0 first:border-none">
