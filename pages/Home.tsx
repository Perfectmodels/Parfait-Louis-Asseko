  ...
  return (
    <div className="text-pm-off-white">
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 p-2 border-2 border-pm-gold/50">
      ...
      <section className="py-24 bg-cover bg-center bg-fixed bg-[url('https://i.ibb.co/LDm73BY2/ventex-44.jpg')]">
        <div className="container mx-auto px-6 text-center bg-black/70 py-12">
            ...
            <Link to="/fashion-day" className="px-10 py-4 bg-pm-gold text-pm-dark font-bold uppercase tracking-widest rounded-full text-center transition-all duration-300 hover:bg-white hover:shadow-2xl hover:shadow-pm-gold/30">
            ...
            {magazineArticlesPreview.map(article => (
              <Link to={article.link} key={article.title} className="group block bg-black border border-pm-gold/20 overflow-hidden transition-all duration-300 hover:border-pm-gold hover:shadow-lg hover:shadow-pm-gold/20">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-playfair text-pm-off-white mt-2 group-hover:text-pm-gold transition-colors">{article.title}</h3>
                </div>
              </Link>
            ))}
          </div>
