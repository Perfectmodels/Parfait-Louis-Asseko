...
// FIX: Import beginnerCourseData directly to resolve module path error by pointing to its location in `src`.
import { beginnerCourseData as initialBeginnerCourseData } from '../src/constants/beginnerCourseData';
