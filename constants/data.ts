...
export const apiKeys: ApiKeys = {
    ...
    // INSTRUCTION: Remplacez l'URL ci-dessous par l'URL de votre Cloudflare Worker pour l'upload d'images.
    cloudflareWorkerUrl: 'https://VOTRE_WORKER.VOTRE_DOMAINE.workers.dev',
};
