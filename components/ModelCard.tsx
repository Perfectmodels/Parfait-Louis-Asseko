...
const ModelCard: React.FC<ModelCardProps> = ({ model }) => {
  return (
    <ReactRouterDOM.Link to={`/mannequins/${model.id}`} className="group block card-base overflow-hidden focus-style-self focus-visible:ring-2 focus-visible:ring-pm-gold focus-visible:ring-offset-2 focus-visible:ring-offset-pm-dark">
